    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_address', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('private_key', models.CharField(blank=True, default=None, max_length=255, null=True)),
